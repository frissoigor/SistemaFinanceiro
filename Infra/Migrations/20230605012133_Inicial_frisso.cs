...
{
    /// <inheritdoc />
    public partial class Inicial_frisso : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sistema Financeiro", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categoria_Sistema Financeiro_SistemaFinanceiroId",
                        column: x => x.SistemaFinanceiroId,
                        principalTable: "Sistema Financeiro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsuarioSistemaFinanceiro_Sistema Financeiro_SistemaFinanceiroId",
                        column: x => x.SistemaFinanceiroId,
                        principalTable: "Sistema Financeiro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioSistemaFinanceiro_SistemaFinanceiroId",
